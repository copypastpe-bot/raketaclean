...
# --- приставка заголовка → район ---
# Канон владельца (2026-08-27) плюс написания, которые встретились в календаре:
# «Сорм» и «Сор» — один район, «Автоз» и «Авто» — тоже.
#
# Внимание: не у каждого района есть значение в списке «Район города» амо.
# Балахнинского и Дальнеконстантиновского там нет — приставку робот поймёт,
# но поле оставит пустым и скажет об этом в вечерней сводке.
DISTRICT_BY_PREFIX: dict[str, str] = {
    "авт": "автозаводский", "автоз": "автозаводский", "авто": "автозаводский",
    "бал": "балахнинский",
    "бог": "богородский",
    "бор": "борский",
    "дал": "дальнеконстантиновский",
    "дзерж": "дзержинский",
    "кан": "канавинский",
    "кст": "кстовский", "ксто": "кстовский",
    "лен": "ленинский",
    "мос": "московский", "моск": "московский",
    "ниж": "нижегородский", "ниже": "нижегородский",
