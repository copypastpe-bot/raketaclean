...
1. /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/AGENT_STATE.md
2. recent entries in /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/SESSION_LOG.md
...
This repository uses central agent memory outside itself, one state and one log for both bots.
If `./AGENT_STATE.md` or `./SESSION_LOG.md` are missing here, that is expected.
Read and update only these registered files:

- State: `/Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/AGENT_STATE.md`
- Log: `/Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/SESSION_LOG.md`
...
- Project context state is centralized in /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/AGENT_STATE.md.
- Project session log is centralized in /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/SESSION_LOG.md.
- Central context lives in `agent1/project_ai_context/`, not in this repository.
- Missing local `AGENT_STATE.md` / `SESSION_LOG.md` in this repository is expected and not an error.
- Do not recreate local AGENT_STATE.md and SESSION_LOG.md in this repository.
...
3. rewrite /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/AGENT_STATE.md to reflect current state;
4. add one new entry at the top of /Users/evgenijpastusenko/Projects/agent1/project_ai_context/raketaclean/SESSION_LOG.md;
