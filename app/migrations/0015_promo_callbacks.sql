...
-- заводит сделку в «Новом лиде» с тегом «Отклик на промо» и ставит её в
-- очередь автозвонка. Что уже обработано, админ-бот помнит у себя (схема
-- adminbot); рабочий бот строки не меняет и не удаляет.
--
